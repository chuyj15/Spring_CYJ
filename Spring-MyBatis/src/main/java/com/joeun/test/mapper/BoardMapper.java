...
public interface BoardMapper {
	...
	//검색
	public List<Board> list(@Param("searchType") Integer searchType, @Param("keyword") String keyword) throws Exception;
	public List<Board> list(Option option) throws Exception;
	
	public List<Board> search(@Param("searchType") String searchType, @Param("keyword") String keyword) throws Exception;
